                                    ...
                                    content=ft.Container(
                                        ...
                                        content=ft.Column(
                                            [
                                                ...
                                                ft.Row(
                                                    [
                                                        ft.ElevatedButton("Далі", width=120,style=ft.ButtonStyle(ft.colors.BLUE_900,side=ft.BorderSide(2,ft.colors.INDIGO_500)),on_click=lambda _: page.go("/store"))
                                                    ],
                        ...
                        [
                            ...
                            ft.Row(
                                    [
                                       ...
                                       }), icon_size=35, tooltip= "Вихід",  on_click=lambda _: page.go("/"))
                                    ],
                                        alignment=ft.MainAxisAlignment.END
                                ),
                            ft.Row(
                                    ...
                                    [
                                       ft.ElevatedButton("Розпочати тест", width=600, style=ft.ButtonStyle(color={
                                       ft.MaterialState.HOVERED: ft.colors.INDIGO_500,
